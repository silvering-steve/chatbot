...
class BaseModel(ABC):
    ...
    def modify_commandline_options(parser, is_train):
        ...
        Parameters:
            ...
            is_train (bool) -- whether training phase or data phase. You can use this flag to add training-specific or data-specific options.
    ...
    @abstractmethod
    def forward(self):
        """Run forward pass; called by both functions <optimize_parameters> and <data>."""
        pass
    ...
    def test(self):
        """Forward function used in data time.
