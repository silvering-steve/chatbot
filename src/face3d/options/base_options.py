...
class BaseOptions():
    """This class defines options used during both training and data time.
    ...
    def initialize(self, parser):
        """Define the common options that are used in both training and data."""
        # basic parameters
    ...
    def parse(self):
        ...
        opt.isTrain = self.isTrain   # train or data
